from webnotes.core.exceptions import FieldError
from webnotes.db import connections
from webnotes.db.backends.util import truncate_name
from webnotes.db.models.sql.constants import *
from webnotes.db.models.sql.datastructures import EmptyResultSet
from webnotes.db.models.sql.expressions import SQLEvaluator
from webnotes.db.models.sql.query import get_proxied_model, get_order_dir, \
...
class SQLUpdateCompiler(SQLCompiler):
    def as_sql(self):
        ...
        parameters.
        """
        from webnotes.db.models.base import Model
...
class SQLDateCompiler(SQLCompiler):
    def results_iter(self):
        ...
        resolve_columns = hasattr(self, 'resolve_columns')
        if resolve_columns:
            from webnotes.db.models.fields import DateTimeField
            fields = [DateTimeField()]
        else:
            from webnotes.db.backends.util import typecast_timestamp

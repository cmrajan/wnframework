...
_r.ReportBuilder.prototype.make_tabs=function(){this.tab_wrapper=$a(this.wrapper,'div','finder_tab_area');this.mytabs=new TrayPage(this.tab_wrapper);this.mytabs.add_item('Result',null,null,1);this.mytabs.add_item('More Filters',null,null,1);this.mytabs.add_item('Select Columns',null,null,1);if(resize_observers.indexOf(_r.set_rb_height==-1))
resize_observers.push(_r.set_rb_height)}
_r.set_rb_height=function(){if(_r.rb_con.cur_rb){var headerh=_r.rb_con.page_head.wrapper.clientHeight;var footerh=_r.rb_con.footer.clientHeight;$y(_r.rb_con.cur_rb.mytabs.body,{height:get_window_height()-headerh-footerh+'px',overflow:'auto'});}}

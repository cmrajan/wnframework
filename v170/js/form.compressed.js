...
_f.FrmContainer.prototype.make_head=function(){var me=this;this.bg_color='#FFF';this.head=$a(this.wrapper,'div','',{margin:'0px 0px 4px 0px'});this.body=$a(this.wrapper,'div');var div=$a(this.head,'div','');this.tbartab=make_table(div,1,3,'100%',['30%','20%','50%'],{paddingTop:'2px'});$y($td(this.tbartab,0,0),{padding:'4px'});this.main_title=$a($td(this.tbartab,0,0),'h1','',{margin:'0px'});this.button_area=$a($td(this.tbartab,0,1),'div','');this.tbar_div=$a($td(this.tbartab,0,2),'div','',{marginRight:'8px',textAlign:'right'})

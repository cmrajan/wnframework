...
_f.Frm.prototype.setup_footer=function(){this.footer=$a(this.body,'div','green_buttons',{fontSize:'13px'});var b=$a(this.footer,'button');b.innerHTML='Save';$(b).button({icons:{primary:'ui-icon-disk'}});b.onclick=function(){cur_frm.save('Save');}}

...
_f.Frm.prototype.refresh_footer=function(){if(this.editable&&!this.meta.in_dialog&&this.doc.docstatus==0&&!this.meta.istable&&this.get_doc_perms()[WRITE]&&this.footer)
this.footer.show_save();else

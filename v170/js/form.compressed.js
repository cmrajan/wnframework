...
this.layout.wrapper.style.backgroundColor='#'+this.meta.colour.split(':')[1];this.setup_fields_std();setTimeout(_f.set_frm_height,100);if(resize_observers.indexOf(_f.set_frm_height==-1))

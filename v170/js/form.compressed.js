...
_f.Frm.prototype.setup_tabs=function(){var me=this;$ds(this.tab_wrapper);$y(this.tab_wrapper,{marginTop:'4px'});this.tabs=new TabbedPage(this.tab_wrapper,1);$y(this.body,{padding:'8px 16px'});}
...
_f.Frm.prototype.setup_footer=function(){this.footer=$a(this.form_wrapper,'div','',{backgroundColor:'#DDF',margin:'4px 0px'});this.footer.tab=make_table(this.footer,1,2,'100%',['50%','50%'],{padding:'4px'});$td(this.footer.tab,0,0).className='green_buttons';$y($td(this.footer.tab,0,1),{textAlign:'right'});var b=$a($td(this.footer.tab,0,0),'button');b.innerHTML='Save';$(b).button({icons:{primary:'ui-icon-disk'}});b.onclick=function(){cur_frm.save('Save');}}
...
_f.SectionBreak.prototype.make_row=function(){this.row=this.frm.layout.addrow();this.row.footer=$a(this.row.wrapper,'div');}

...
Field.prototype.set_comment=function(){var me=this;if(this.df.description){$ds(this.help_icon);this.help_icon.onclick=function(){msgprint(me.df.description)};}else{$dh(this.help_icon);}}

...
var with_color_map=0;if(!_tags.color_map)with_color_map=1;$c_obj('Menu Control','get_dt_details',JSON.stringify([this.dt,cstr(this.field_list),with_color_map]),callback);this.loaded=1;}

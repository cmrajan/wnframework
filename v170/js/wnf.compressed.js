...
Field.prototype.set_comment=function(){var me=this;this.comment_area.innerHTML='';if(this.df.description){if(this.df.description.length>120){$($a(this.comment_area,'div')).html(this.df.description.substr(0,120)+'...');$($a(this.comment_area,'div','link_type',{fontSize:'11px'})).html('more').click(function(){msgprint(me.df.description)});}else{this.comment_area.innerHTML=replace_newlines(this.df.description);}
$ds(this.comment_area);}else{$dh(this.comment_area);}}
...
Field.prototype.refresh_display=function(){if(!this.set_status||this.set_status!=this.disp_status){if(this.disp_status=='Write'){if(this.make_input&&(!this.input)){this.make_input();this.set_comment();}

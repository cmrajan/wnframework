	...
	try:
		...
		if webnotes.conn:
			...
			if webnotes.session['user'] == 'Guest':
				if cmd not in ['runserverobj', 'webnotes.widgets.form.getdoc','webnotes.widgets.form.getdoctype','logout','webnotes.widgets.page.getpage','get_file','webnotes.widgets.query_builder.runquery']:
